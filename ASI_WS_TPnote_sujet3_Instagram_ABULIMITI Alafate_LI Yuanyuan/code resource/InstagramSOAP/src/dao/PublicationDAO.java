...
public class PublicationDAO {
	...
	/**
	 * convert a publication to a string with id, comment, path of image, user id
	...
	public String convertToAString(Publication publication) {
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
		String date = simpleDateFormat.format(publication.getDate());
		String result = "publication id: " + publication.getpId() + ", " + "publication comment: "
				+ publication.getComment() + ", " + "publication imagePath: " + publication.getImagePath() + ", "
				+ "publication user id: " + publication.getUser().getuId() + ", " + "the day of publication: " + date;
		return result;
	}
}

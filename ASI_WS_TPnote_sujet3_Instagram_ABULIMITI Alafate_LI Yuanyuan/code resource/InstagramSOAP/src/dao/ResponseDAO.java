...
public class ResponseDAO {
	...
	/**
	 * convert a response to string with id, comment, user Id, date of response,
	 * publication ID, publication comment, user Id of publication.
	 * 
	 * @param response
	 *            : response
	 * @return string
	 */
	public String convertToAString(Response response) {
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
		String date = simpleDateFormat.format(response.getDate());

		String result = "response Id: " + response.getrId() + ", " + "response comment: " + response.getComment() + ", "
				+ "response user Id: " + response.getUser().getuId() + ", " + "the date of response: " + date + ", "
				+ "publication Id: " + response.getPublication().getpId() + ", " + "publication comment: "
				+ response.getPublication().getComment() + ", " + "publication user Id: "
				+ response.getPublication().getUser().getuId();
		return result;
	}
}

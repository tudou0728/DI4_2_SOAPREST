...
public class FollowsService {
	...
	public String convertToAString(Follows follows) {
		return followsDAO.convertToAString(follows);
	}

	/**
	 * convert a list of follows to list of string
	 * 
	 * @param follows
	 *            : list of follows
	 * @return list of string
	 */
	public List<String> convertListToString(List<Follows> follows) {
		List<String> lists = new ArrayList<>();
		for (int i = 0; i < follows.size(); i++) {
			lists.add(followsDAO.convertToAString(follows.get(i)));
		}
		return lists;
	}
}

...
public class UserWSServiceLocator extends org.apache.axis.client.Service implements webService.UserWSService {
    ...
    private java.lang.String UserWS_address = "http://localhost:8080/InstagramSOAP/services/UserWS";
    ...
    public webService.UserWS getUserWS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webService.UserWSSoapBindingStub _stub = new webService.UserWSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webService.UserWS.class.isAssignableFrom(serviceEndpointInterface)) {
                webService.UserWSSoapBindingStub _stub = new webService.UserWSSoapBindingStub(new java.net.URL(UserWS_address), this);
                _stub.setPortName(getUserWSWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webService", "UserWSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webService", "UserWS"));
        }
